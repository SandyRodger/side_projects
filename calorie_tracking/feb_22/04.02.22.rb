...
monday_porridge = {
	...
	:string_beans => 223,
	:brocolli => 350,
	:aldi_kidney_beans_with_ring => 485,
	:baby_plum_tomatoes => 240,
	:babycorn => 162,
	:chia_seeds => 41,
	:sweetcorn => 340,
	:veggie_stock_cubes => 20
...
monday_porridge_weight = 2254 + 1419
friday_rice_weight = 2296 + 1661
wednesday_sweet_potato_weight = 2444 + 484
friday_sweet_potato = 1108 + 1974
...
friday_rice_macros = calories_calculator(friday_rice, calories_fat_protein_carbs_fibre)

friday_rice_grams = friday_rice_macros.map do |num|
	(num.to_f/friday_rice_weight).round(3)
end

calories_fat_protein_carbs_fibre [:friday_rice_grams] = friday_rice_grams
...
# friday_sweet_potato_macros = calories_calculator(friday_sweet_potato, calories_fat_protein_carbs_fibre)

# friday_sweet_potato_grams = friday_sweet_potato_macros.map do |num|
# 	(num.to_f/friday_sweet_potato_weight).round(3)
# end

# calories_fat_protein_carbs_fibre [:friday_sweet_potato_grams] = friday_sweet_potato_grams

# puts "Each gram in friday_rice's cook has #{friday_rice_grams[0]} calories, #{friday_rice_grams[1]}g fat #{friday_rice_grams[2]}g protein, #{friday_rice_grams[3]}g carbs and  #{friday_rice_grams[4]}g fibre" 

today_input = {
	# # 12:30
	# :vegan_gainz_protein => THREE_LEVEL_SCOOPS_VEGAN_GAINZ,
	# # 14:20
	# :monday_porridge_grams => 416,
	# :wednesday_sweet_potato_grams => 598,
	# :pear => 136,
	# :nectarine => 89,
	# :orange => 177,
	# # 16:40
	# :wednesday_sweet_potato_grams => 487,
	# :oatcakes => 11 * 9,
	# :crunchy_PB => 16 * 3,
	# :banana => 90
	# 20:00

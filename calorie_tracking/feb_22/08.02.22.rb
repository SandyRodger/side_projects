...
calories_fat_protein_carbs_fibre = {
	...
	:biscuit_bourbon => [4.94, 0.21, 0.05, 0.71, 0], # 1 = 13.9g
...
# puts "Each gram in tuesday_rice's cook has #{tuesday_rice_grams[0]} calories, #{tuesday_rice_grams[1]}g fat #{tuesday_rice_grams[2]}g protein, #{tuesday_rice_grams[3]}g carbs and  #{tuesday_rice_grams[4]}g fibre" 

today_input = {
	# 08:00
	 # :monday_porridge_grams => 1539 - WHITE_BOWL,
	# # 13:20
	# :apple => 100,
	# :tuesday_rice_grams => 1092,
	# # 17:48
	# :tuesday_sweet_potato_grams => 532,
	# 20:00
	# :biscuit_bourbon => ONE_BOURBON * 3,
	# # 21:40
	# :tuesday_rice_grams => 655,
	:red_wine => WINE_BOTTLE/3
}

today_macros = calories_calculator(today_input, calories_fat_protein_carbs_fibre)

  puts "today: (Tuesday 8th) 

...
wednesday_lentils_weight = 1510 + 1105
...
wednesday_lentils_macros = calories_calculator(wednesday_lentils, calories_fat_protein_carbs_fibre)

wednesday_lentils_grams = wednesday_lentils_macros.map do |num|
	(num.to_f/wednesday_lentils_weight).round(3)
end

calories_fat_protein_carbs_fibre [:wednesday_lentils_grams] = wednesday_lentils_grams
...
# puts "Each gram in wednesday_sweet_potato's cook has #{wednesday_sweet_potato_grams[0]} calories, #{wednesday_sweet_potato_grams[1]}g fat #{wednesday_sweet_potato_grams[2]}g protein, #{wednesday_sweet_potato_grams[3]}g carbs and  #{wednesday_sweet_potato_grams[4]}g fibre" 

today_input = {
	# BREAKFAST AT 12:30
	:wednesday_lentils_grams => 1186 + 310,
	:pear => 125,
	:nectarine => 81 * 2,
	:orange => 194 * 2,
	# 17:30
	:wednesday_sweet_potato_grams => 1045,
	:rye_crispbread_with_sesame_seeds => 30,
	:margarine => 15 + 55,
	:banana => 92,
	# nectarine
	# orange
	# 21:30
	:gnocchi => 400,
	:pasta_sauce_tomato_coop => 340,
	# wednesday_lentils => 310
	# margarine => 55
	# BEER
	:guiness => 440 * 4
}

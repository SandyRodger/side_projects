...
calories_fat_protein_carbs_fibre = {
	...
	:aldi_vegan_cheese_bake => [2.72, 0.16, 0.046, 0.27, 0.023],
	...
	:vegan_teriyaki_beef => [2.01, 0.075, 0.154, 0.146, 0.071],
...
# puts "Each gram in thursday_rice's cook has #{thursday_rice_grams[0]} calories, #{thursday_rice_grams[1]}g fat #{thursday_rice_grams[2]}g protein, #{thursday_rice_grams[3]}g carbs and  #{thursday_rice_grams[4]}g fibre" 

today_input = {
	# 10:40
	# :thursday_rice_grams => 672,
	# :olive_oil => 23,
	# :orange => 159,
	# :apple => 135,
	# 14:20
	# :carrots => 86,
	# :thursday_brocolli_grams => 463,
	# :chimichuri_olives => 85,
	# :vegan_teriyaki_beef => 100,
	# :thursday_rice_grams => 469,
	# :blueberry_wheats_cereal => 143,
	# :aldi_oat_drink => 305,
	# :moser_roth_vegan_chocolate => 5,
	# 17:50
	# :aldi_vegan_cheese_bake => 144 * 2,
}

today_macros = calories_calculator(today_input, calories_fat_protein_carbs_fibre)

  puts "today: (Saturday 12th) 

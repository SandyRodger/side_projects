...
saturday_rice = {
	...
	:string_beans => 215, 
	:green_beans => 204,
	:baby_plum_tomatoes => 336,
	:chia_seeds => 33,
	:aldi_kidney_beans_with_ring => 486,
	:passata => 500
}
...
saturday_rice_weight = 2270 + 1492 + 471
...
calories_fat_protein_carbs_fibre = {
	...
	:mango => [0.65, 0.0027, 0.0051, 0.17, 0.018],
	...
	:vegan_potato_salad => [1.53, 0.11, 0.012, 0.12, 0.011], 
...
saturday_rice_macros = calories_calculator(saturday_rice, calories_fat_protein_carbs_fibre)

saturday_rice_grams = saturday_rice_macros.map do |num|
	(num.to_f/saturday_rice_weight).round(3)
end

calories_fat_protein_carbs_fibre [:saturday_rice_grams] = saturday_rice_grams
...
calories_fat_protein_carbs_fibre [:monday_porridge_grams] = monday_porridge_grams
 ...
 # puts "Each gram in monday_porridge's cook has #{monday_porridge_grams[0]} calories, #{monday_porridge_grams[1]}g fat #{monday_porridge_grams[2]}g protein, #{monday_porridge_grams[3]}g carbs and  #{monday_porridge_grams[4]}g fibre" 

today_input = {
	:vegan_gainz_protein => THREE_LEVEL_SCOOPS_VEGAN_GAINZ,
	# BREAKFAST AT 3PM
	:saturday_rice_grams => 540,
	:monday_porridge_grams => 458 + 700,
	:apple => 171,
	:orange => 92 * 2,
	# PRE-LIFE DRAWING SNACK
	:crunchy_PB => 50,
	:oatcakes => 11 * 4,
	:vegan_yoghurt => 100 + 100,
	:vegan_potato_salad => 300,
	# BEER
	 :guiness => 500,
	# 1AM DINNER
	:vegan_cheddar => 50,

...
sunday_lentil = {
 ...
 :veggie_stock_cubes => 20,
 :passata => 500,
 :spicy_green_olive => 170,
}

sunday_lentil_weight = 1161 + 1937
sunday_rice_weight = 1402 + 973 + 792
...
sunday_rice_macros = calories_calculator(sunday_rice, calories_fat_protein_carbs_fibre)

sunday_rice_grams = sunday_rice_macros.map do |num|
	(num.to_f/sunday_rice_weight).round(3)
end

calories_fat_protein_carbs_fibre [:sunday_rice_grams] = sunday_rice_grams

# sunday_lentil

sunday_lentil_macros = calories_calculator(sunday_lentil, calories_fat_protein_carbs_fibre)

sunday_lentil_grams = sunday_lentil_macros.map do |num|
	(num.to_f/sunday_lentil_weight).round(3)
end

calories_fat_protein_carbs_fibre [:sunday_lentil_grams] = sunday_lentil_grams

# puts "Each gram in sunday_lentil's cook has #{sunday_lentil_grams[0]} calories, #{sunday_lentil_grams[1]}g fat #{sunday_lentil_grams[2]}g protein, #{sunday_lentil_grams[3]}g carbs and  #{sunday_lentil_grams[4]}g fibre" 

today_input = {
	# 08:00
	# :blueberry_wheats_cereal => 141,
	# :aldi_oat_drink => 311,
	# :v_chicken_burger => 101,
	# 12:00
	# :brown_spag => 170,
	# :white_onion => 370,
	# :olive_oil => 32,
	# :chimichuri_olives => 70,
	# :mango => 200, 
	# 16:00
	# :sunday_rice_grams => 792,
	# red_wine 17:00 -
	# 19:00
	# :sunday_lentil_grams => 1161
  :red_wine => WINE_IN_FULL_BOTTLE * 0.8
 }

today_macros = calories_calculator(today_input, calories_fat_protein_carbs_fibre)

  puts "today: (Sunday 13th) 

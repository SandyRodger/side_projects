...
friday_sweet_potato_weight = 1108 + 1974
...
# puts "Each gram in friday_sweet_potato's cook has #{friday_sweet_potato_grams[0]} calories, #{friday_sweet_potato_grams[1]}g fat #{friday_sweet_potato_grams[2]}g protein, #{friday_sweet_potato_grams[3]}g carbs and  #{friday_sweet_potato_grams[4]}g fibre" 

today_input = {
	# 14:45
	# :friday_sweet_potato_grams => 964,
	# :cucumber => 133,
	# :pear => 129,
	# :oatcakes => 11 * 5,
	# # 17:00
	# :friday_rice_grams => 940,
	# :nectarine => 90
	# 20:00
	# :friday_rice_grams => 310,
	# :friday_sweet_potato_grams => 598,
	# :blueberries => 70,
	# :vegan_yoghurt => 231,
	# :oatcakes => 11 * 7,
	# 21:30
	# :fizzy_fish_sweets => 160,
	# :red_wine => WINE_BOTTLE/2,
	# 00:00
	:brown_spag => 204,
	:margarine => 48,
	:instant_noodles => 60,

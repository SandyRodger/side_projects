...
mon_aubergine_weight = 1644 + 1178 + 253 + 954
wed_por_weight = 2683 + 1047 + 782

wed_por = gram_maker(wed_por_ingredients, wed_por_weight)
CFPCF[:wed_por] = wed_por
mon_aubergine = gram_maker(mon_aubergine_ingredients, mon_aubergine_weight)
CFPCF[:mon_aubergine] = mon_aubergine
...
#{wed_por_grams[0]} calories, 
#{wed_por_grams[1]}g fat 
#{wed_por_grams[2]}g protein, 
#{wed_por_grams[3]}g carbs and  
#{wed_por_grams[4]}g fibre" 

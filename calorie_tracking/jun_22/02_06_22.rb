...
thursday_spaghetti = {
	...
	olive_oil: 40,
	white_onion: 114,
	dark_soy_sauce: 227 - 196,
	mayonaise: 347 - 270,
}

wednesday_porridge_weight = 2105 + 1579 + 371
thursday_spaghetti_weight = 600
...
thursday_spaghetti_macros = calories_calculator(thursday_spaghetti, calories_fat_protein_carbs_fibre)

thursday_spaghetti_grams = thursday_spaghetti_macros.map do |num|
	(num.to_f/thursday_spaghetti_weight).round(3)
end

calories_fat_protein_carbs_fibre [:thursday_spaghetti_grams] = thursday_spaghetti_grams
...
today_input = {
	# orange_juice_tropicana: 301,
	# butter_milk: 254,
	# wednesday_porridge_grams: 788,
	# oatcakes: 127 - 53,
	# banana: 139 + 136,
	# crunchy_PB: 146 - 63,
	# orange: 159,

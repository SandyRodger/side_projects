...
def calories_calculator(ingredients)
	...
	ingredients.each do |food, weight|
		output.each_with_index do |macro, idx|
			output[idx] += CFPCF[food][idx]*weight
		end
	end
	output.map(&:round)
end
...
sunday_sweet_potato_ingredients = {
	sweet_potato: 1011,
	olive_oil: 20,
	anchovies_in_oo_drained: 30,
	white_onion: 184,
...
wednesday_porridge_ingredients = {
	chicken_breast: 500,
	anchovies_in_oo_drained: 30,
	olive_oil: 20,
	veggie_stock_cubes: 20,
	oats: 218,
	egg: ONE_MEDIUM_EGG * 3,
...
wednesday_porridge_weight = 2683 + 1047 + 782
sunday_sweet_potato_weight = 2638 + 1302

wednesday_porridge = gram_maker(wednesday_porridge_ingredients, wednesday_porridge_weight)
CFPCF[:wednesday_porridge] = wednesday_porridge
monday_aubergine = gram_maker(monday_aubergine_ingredients, monday_aubergine_weight)
CFPCF[:monday_aubergine] = monday_aubergine
sunday_sweet_potato = gram_maker(sunday_sweet_potato_ingredients, sunday_sweet_potato_weight)
CFPCF[:sunday_sweet_potato] = sunday_sweet_potato
...
today_input = {
	...
	monday_aubergine: 898,
	apple: 128,
	grapefruit:137,
	wednesday_porridge: 830 + 212,
	satsuma: 44,
	orange: 144,
	pear: 167,
	egg: ONE_MEDIUM_EGG * 2,
	almond:  61,
	oatcakes: 11 * 9,
	sunday_sweet_potato: 236,
	mayonaise: 73,
	cucumber: 50,
	cherry_tomatoes: 66,
	mango: 289,

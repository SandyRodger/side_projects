...
wednesday_porridge = {
	red_cabbage: 1640,
	oats: 202,
	veggie_stock_cubes: 40,
	brocolli: 319 - 88,
	chia_seeds: 27,
	passata: 400,
	tempeh: 200,
	nutritional_yeast: 40 
}
...
wednesday_porridge_weight = 2105 + 1579 + 371
sunday_rice_weight = 2111 + 1157
...
wednesday_porridge_macros = calories_calculator(wednesday_porridge, calories_fat_protein_carbs_fibre)

wednesday_porridge_grams = wednesday_porridge_macros.map do |num|
	(num.to_f/wednesday_porridge_weight).round(3)
end

calories_fat_protein_carbs_fibre [:wednesday_porridge_grams] = wednesday_porridge_grams
...
today_input = {
	# 10:30
	wednesday_porridge_grams: 766,
	apricot: 127,
	apple: 136,
	wednesday_porridge_grams: 856,
	butter_milk: 295,
	whole_seed_bread: 95,
	sunday_rice_grams: 351,
	oatcakes: 107,
	almond: 31,
	honey: 455 - 396,
	#21:00
	orange_juice_tropicana: 291 * 2,
	brown_spag: 190,
	banana: 170,
	chopped_tomatoes_co_op: 370,
	mayonaise: 80,
}

today_macros = calories_calculator(today_input, calories_fat_protein_carbs_fibre)

 puts "today: (Wednesday 1st June) 

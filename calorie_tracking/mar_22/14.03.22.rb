...
# puts "Each gram in sunday_sweet_pot's cook has #{sunday_sweet_pot_grams[0]} calories, #{sunday_sweet_pot_grams[1]}g fat #{sunday_sweet_pot_grams[2]}g protein, #{sunday_sweet_pot_grams[3]}g carbs and  #{sunday_sweet_pot_grams[4]}g fibre" 

today_input = {
	:sunday_sweet_pot_grams => 771,
	:orange => 80,
	:kiwi => 60,
	# incomplete
 }

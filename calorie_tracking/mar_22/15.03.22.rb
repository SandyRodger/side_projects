...
sunday_sweet_pot_weight = (2004 - SMALL_GLASS_POT) + (2993 - MEDIUM_GLASS_POT)
tuesday_rice_weight = 2309 + 1124 + 1101
...
sunday_sweet_pot_macros = calories_calculator(sunday_sweet_pot, calories_fat_protein_carbs_fibre)

sunday_sweet_pot_grams = sunday_sweet_pot_macros.map do |num|
	(num.to_f/sunday_sweet_pot_weight).round(3)
end

calories_fat_protein_carbs_fibre [:sunday_sweet_pot_grams] = sunday_sweet_pot_grams
...
# puts "Each gram in tuesday's_rice cook has #{tuesday_rice_grams[0]} calories, #{tuesday_rice_grams[1]}g fat #{tuesday_rice_grams[2]}g protein, #{tuesday_rice_grams[3]}g carbs and  #{tuesday_rice_grams[4]}g fibre" 

today_input = {
	# 11:00
	:v_gainz_protein => THREE_LEVEL_SCOOPS_v_GAINZ,
	# 13:50
	:sunday_sweet_pot_grams => 973,
	:orange => 131,
	:kiwi => 53,
	:nectarine => 84,
	:oatcakes => 10 * 11,

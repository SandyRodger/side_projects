...
# puts "Each gram in wednesday_cauliflower's cook has #{wednesday_cauliflower_grams[0]} calories, #{wednesday_cauliflower_grams[1]}g fat #{wednesday_cauliflower_grams[2]}g protein, #{wednesday_cauliflower_grams[3]}g carbs and  #{wednesday_cauliflower_grams[4]}g fibre" 

today_input = {
	:vegan_celebration_chocolate_cake => 94,
	:aldi_oat_drink => 113,
	:wednesday_cauliflower_grams => 633,
	:oatcakes => 55,
	:almond => 45,
	:apple => 114 * 2, 
	:raisins_and_cranberries => 65,
	:banana => 78,
	:wednesday_sweet_potato_grams => 642,
	:olive_oil => 24,
	:honey => 26,
}

...
friday_cook = {
	...
	:aldi_kidney_beans => 440,
	:chia_seeds => 37,
	:baby_plum_tomatoes => 190,
	:spinach => 450,
...
friday_cook_macros = calories_calculator(friday_cook, calories_fat_protein_carbs_fibre)
...
calories_fat_protein_carbs_fibre [:friday_cook_grams] = friday_cook_grams
calories_fat_protein_carbs_fibre [:monday_cook_grams] = monday_cook_grams
# puts "Each gram in Monday's cook has #{friday_cook_grams[0]} calories, #{monday_cook_grams[1]}g fat #{monday_cook_grams[2]}g protein, #{monday_cook_grams[3]}g carbs" 

monday_input = {
	:huel_protein => 54,
	:carrots => 108,
	:apple => 92,
	:wednesday_cook_grams => 418,
	:pear => 139,
	:friday_cook_grams => 682,
	:almond => 51,
	:aldi_oat_drink => 20,
	:nectarine => 87,
	:kiwi => 112,
	:monday_cook_grams => 1719
}

monday_macros = calories_calculator(monday_input, calories_fat_protein_carbs_fibre)

puts "today (monday 10th) thus far, i have consumed #{monday_macros[0]}/3,207 calories, #{monday_macros[1]}/91g fat, #{monday_macros[2]}/120g protein, #{monday_macros[3]}/428g carbs and #{monday_macros[4]}g fibre"
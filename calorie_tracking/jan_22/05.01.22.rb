...
wednesday_input = {
	:monday_cook_grams => 1032 + 692,
	:tuesday_cook_grams => 720,
	:kiwi => 59,
	:dried_prunes => 97,
	:apple => 112,
	:grapefruit => 208,
...
wednesday_macros = calories_calculator(wednesday_input, calories_fat_protein_carbs)

# puts "today (Wednesday 5th) thus far, i have consumed #{wednesday_macros[0]}/3,207 calories, #{wednesday_macros[1]}/91g fat, #{wednesday_macros[2]}/120g protein, #{wednesday_macros[3]}/428g carbs"
...
yesterday_sweet_potato_weight = 1751 + 447
yesterday_cauliflower_weight = 709 + 1333 + 219
...
yesterday_sweet_potato_macros = calories_calculator(yesterday_sweet_potato, calories_fat_protein_carbs_fibre)

yesterday_sweet_potato_grams = yesterday_sweet_potato_macros.map do |num|
	(num.to_f/yesterday_sweet_potato_weight).round(3)
end

calories_fat_protein_carbs_fibre [:yesterday_sweet_potato_grams] = yesterday_sweet_potato_grams

# yesterday_CAULIFLOWER

yesterday_cauliflower_macros = calories_calculator(yesterday_cauliflower, calories_fat_protein_carbs_fibre)

yesterday_cauliflower_grams = yesterday_cauliflower_macros.map do |num|
	(num.to_f/yesterday_cauliflower_weight).round(3)
end

calories_fat_protein_carbs_fibre [:yesterday_cauliflower_grams] = yesterday_cauliflower_grams

# puts "Each gram in yesterday_cauliflower's cook has #{yesterday_cauliflower_grams[0]} calories, #{yesterday_cauliflower_grams[1]}g fat #{yesterday_cauliflower_grams[2]}g protein, #{yesterday_cauliflower_grams[3]}g carbs and  #{yesterday_cauliflower_grams[4]}g fibre" 

today_input = {
	:aldi_plant_menu_chicken => 128,
	:apple => 105,
	:orange => 177 + 164,
	:banana => 78,
	:yesterday_cauliflower_grams => 707,
	:dried_figs => 54,
	:yesterday_sweet_potato_grams => 702,
	:blueberries => 73,
	:dried_prunes => 74,
	:crunchy_PB => 92,
	:oatcakes => 64,
	:vegan_celebration_chocolate_cake => 94,
	:stir_fried_rice => 800,
	:white_wine => 500,
}

...
today_input = {
	...
	:banana => 66 * 2,
	:saturday_porridge_grams => 1008,
  :vegan_celebration_chocolate_cake => 87,
	:aldi_oat_drink => 98,
	:bbq_sauce => 39,
	:ketchup => 52,
	:saturday_beetroot_grams => 268 + 421,
	:raisins_and_cranberries => 80,
	:oatcakes => 64,
	:almond => 52,
	:olive_oil => 23,
	:wednesday_sweet_potato_grams => 385,
  :whiskey => 60 + 70 + 60,
	:rye_crispbread_with_sesame_seeds => 11 * 9,
	:aldi_sunflower_spread => 7 * 9,
	:marmalade => 30 * 7	
}

today_macros = calories_calculator(today_input, calories_fat_protein_carbs_fibre)

 puts "today: (Sunday 23rd) 

...
# puts "Each gram in monday's cook has #{monday_cook_grams[0]} calories, #{monday_cook_grams[1]}g fat #{monday_cook_grams[2]}g protein, #{monday_cook_grams[3]}g carbs" 

monday_input = {
	:monday_cook_grams => 655,
	:rye_crispbread_with_sesame_seeds => 30,
	:huel_protein => 54,
	:sunday_cook_grams => 581 + 750,
	:olive_oil => 45,
	:orange => 135,
	:dried_prunes => 84,
	:kiwi => 56,

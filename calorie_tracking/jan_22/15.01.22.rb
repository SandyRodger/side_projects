...
saturday_macros = calories_calculator(saturday_input, calories_fat_protein_carbs_fibre)

puts "today: (Friday 14th) 
#{saturday_macros[0]}/3,207 calories, 
#{saturday_macros[1]}/91g fat, 
#{saturday_macros[2]}/120g protein, 
#{saturday_macros[3]}/428g carbs  
#{saturday_macros[4]}g fibre"

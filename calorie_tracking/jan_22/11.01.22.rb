...
monday_cook = {
	...
	:green_beans => 180,
	:mushrooms => 103,
	:baby_plum_tomatoes => 187,
	:nutritional_yeast => 21,
	:chia_seeds => 23,
	:cucumber => 301
}
...
monday_cook_macros = calories_calculator( monday_cook, calories_fat_protein_carbs_fibre)
...
calories_fat_protein_carbs_fibre [:monday_cook_grams] = monday_cook_grams
calories_fat_protein_carbs_fibre [:tuesday_cook_grams] = tuesday_cook_grams
puts "Each gram in tuesday's cook has #{tuesday_cook_grams[0]} calories, #{tuesday_cook_grams[1]}g fat #{tuesday_cook_grams[2]}g protein, #{tuesday_cook_grams[3]}g carbs and  #{tuesday_cook_grams[4]}g fibre" 

tuesday_input = {
	:huel_protein => 54,
	:tuesday_cook_grams => 883 + 687,
	:pear => 156,
	:grapefruit => 208,
	:honeydew_melon => 344,
	:banana => 250,
	...
	:crunchy_PB => 200,
	:grapes => 103,
	:aldi_plant_menu_chicken => 126
}

tuesday_macros = calories_calculator(tuesday_input, calories_fat_protein_carbs_fibre)

puts "today (monday 10th) thus far, i have consumed #{tuesday_macros[0]}/3,207 calories, #{tuesday_macros[1]}/91g fat, #{tuesday_macros[2]}/120g protein, #{tuesday_macros[3]}/428g carbs and #{tuesday_macros[4]}g fibre"
...
calories_fat_protein_carbs_fibre ={
	...
	:baked_potato => [0.93, 0.01, 0.02, 0.21, 0.02],
...
friday_input = {
	:thursday_cook_grams => 1908,
	:ale => 568 * 2.5,
	:fruit_cake_with_icing => 300,
	:vegan_pie => 400,
	:spinach => 50,
	:carrots => 50,
	:baked_potato => 110
...
friday_macros = calories_calculator(friday_input, calories_fat_protein_carbs_fibre)

puts "today: (Friday 14th) 
#{friday_macros[0]}/3,207 calories, 
#{friday_macros[1]}/91g fat, 
#{friday_macros[2]}/120g protein, 
#{friday_macros[3]}/428g carbs  
#{friday_macros[4]}g fibre"

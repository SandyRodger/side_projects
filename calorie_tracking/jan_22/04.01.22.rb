...
puts "Each gram in Tuesday's cook has #{tuesday_cook_grams[0]} calories, #{tuesday_cook_grams[1]}g fat #{tuesday_cook_grams[2]}g protein, #{tuesday_cook_grams[3]}g carbs" 

tuesday_input = {
	:monday_cook_grams => 905,
	:huel_protein => 54,
	:sunday_cook_grams => 611,
	:orange => 141 +183,
	:apple => 113 * 2,
	:dried_prunes =>90,
	:vegan_coleslaw => 84,
	:houmous => 94,
	:kiwi => 55,
	:tuesday_cook_grams => 755,
	:vegan_beef_burgers => 98,
	:cake => 60
}

tuesday_macros = calories_calculator(tuesday_input, calories_fat_protein_carbs)

puts "today (tuesday 4th) thus far, i have consumed #{tuesday_macros[0]}/3,207 calories, #{tuesday_macros[1]}/91g fat, #{tuesday_macros[2]}/120g protein, #{tuesday_macros[3]}/428g carbs"
...
friday_cook_macros = calories_calculator(friday_cook, calories_fat_protein_carbs)
...
friday_input = {
	:huel_protein => 54,
	:wednesday_cook_grams => 946,
	:pear => 157,
	:grapefruit => 253,
	# :friday_cook_grams => 2000, #=> green lunch box
}

friday_macros = calories_calculator(friday_input, calories_fat_protein_carbs)

# puts "today (Thursday 6th) thus far, i have consumed #{friday_macros[0]}/3,207 calories, #{friday_macros[1]}/91g fat, #{friday_macros[2]}/120g protein, #{friday_macros[3]}/428g carbs"
...
wednesday_sweet_potato_weight = 1751 + 447
wednesday_cauliflower_weight = 709 + 1333 + 219
saturday_porridge_weight = 2439 + 224
saturday_beetroot_weight = 1272 + 560 + 278
...
wednesday_sweet_potato_macros = calories_calculator(wednesday_sweet_potato, calories_fat_protein_carbs_fibre)

wednesday_sweet_potato_grams = wednesday_sweet_potato_macros.map do |num|
	(num.to_f/wednesday_sweet_potato_weight).round(3)
end

calories_fat_protein_carbs_fibre [:wednesday_sweet_potato_grams] = wednesday_sweet_potato_grams

# wednesday_CAULIFLOWER

wednesday_cauliflower_macros = calories_calculator(wednesday_cauliflower, calories_fat_protein_carbs_fibre)

wednesday_cauliflower_grams = wednesday_cauliflower_macros.map do |num|
	(num.to_f/wednesday_cauliflower_weight).round(3)
end

calories_fat_protein_carbs_fibre [:wednesday_cauliflower_grams] = wednesday_cauliflower_grams
...
saturday_beetroot_macros = calories_calculator(saturday_beetroot, calories_fat_protein_carbs_fibre)

saturday_beetroot_grams = saturday_beetroot_macros.map do |num|
	(num.to_f/saturday_beetroot_weight).round(3)
end

calories_fat_protein_carbs_fibre [:saturday_beetroot_grams] = saturday_beetroot_grams

 puts "Each gram in saturday_beetroot's cook has #{saturday_beetroot_grams[0]} calories, #{saturday_beetroot_grams[1]}g fat #{saturday_beetroot_grams[2]}g protein, #{saturday_beetroot_grams[3]}g carbs and  #{saturday_beetroot_grams[4]}g fibre" 

today_input = {
	# :vegan_gainz_protein =>  THREE_LEVEL_SCOOPS_VEGAN_GAINZ,
	# :wednesday_cauliflower_grams => 676,
	# :oatcakes => 64 * 3,
	# :apple => 98, 
	# :banana => 66,
	# :dried_prunes => 48,
	# :saturday_porridge_grams => 224,
	# :saturday_beetroot_grams => 560,
	# :vegan_celebration_chocolate_cake => 85,
	# :aldi_oat_drink => 96,
	:saturday_porridge_grams => 920,
	:olive_oil => 20
}

today_macros = calories_calculator(today_input, calories_fat_protein_carbs_fibre)

# puts "today: (Saturday 22nd) 

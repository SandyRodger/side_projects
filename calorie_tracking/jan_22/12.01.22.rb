...
tuesday_weight = 833 + (3697 - BIG_GLASS_POT)
...
tuesday_cook_macros = calories_calculator( tuesday_cook, calories_fat_protein_carbs_fibre)
...
calories_fat_protein_carbs_fibre [:tuesday_cook_grams] = tuesday_cook_grams
calories_fat_protein_carbs_fibre [:wednesday_cook_grams] = wednesday_cook_grams
# puts "Each gram in wednesday's cook has #{wednesday_cook_grams[0]} calories, #{wednesday_cook_grams[1]}g fat #{wednesday_cook_grams[2]}g protein, #{wednesday_cook_grams[3]}g carbs and  #{wednesday_cook_grams[4]}g fibre" 

wednesday_input = {
	:tuesday_cook_grams => 905 + 482,
	:kiwi => 100,
	:apple => 113,
	:honeydew_melon => 251,
	:grapes => 103,
...
huel_protein_macros = calories_calculator(huel_protein, calories_fat_protein_carbs_fibre)
vegan_gainz_macros = calories_calculator(vegain_gainz, calories_fat_protein_carbs_fibre)
wednesday_macros = calories_calculator(wednesday_input, calories_fat_protein_carbs_fibre)

puts "today: (Wednesday 12th) 
#{wednesday_macros[0]}/3,207 calories, 
#{wednesday_macros[1]}/91g fat, 
#{wednesday_macros[2]}/120g protein, 
#{wednesday_macros[3]}/428g carbs  
#{wednesday_macros[4]}g fibre"

#  puts "3 scoops of Vegan Gainz
#  #{vegan_gainz_macros[0]}/3,207 calories, 
#  #{vegan_gainz_macros[1]}/91g fat, 
#  #{vegan_gainz_macros[2]}/120g protein, 
#  #{vegan_gainz_macros[3]}/428g carbs  
#  #{vegan_gainz_macros[4]}g fibre"

#  puts "2 scoops of huel protein
#  #{huel_protein_macros[0]}/3,207 calories, 
#  #{huel_protein_macros[1]}/91g fat, 
#  #{huel_protein_macros[2]}/120g protein, 
#  #{huel_protein_macros[3]}/428g carbs  
#  #{huel_protein_macros[4]}g fibre"
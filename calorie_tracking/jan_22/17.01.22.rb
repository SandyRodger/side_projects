...
# puts "Each gram in monday's cook has #{monday_cook_grams[0]} calories, #{monday_cook_grams[1]}g fat #{monday_cook_grams[2]}g protein, #{monday_cook_grams[3]}g carbs and  #{monday_cook_grams[4]}g fibre" 

monday_input = {
	:monday_cook_grams => 657 + 925 + 1351,
  :vegan_gainz_protein => THREE_LEVEL_SCOOPS_VEGAN_GAINZ,
	:rye_crispbread_with_sesame_seeds => 22,
	:oatcakes => 66,
	:apple => 104 * 2,
	:orange => 105,
	:banana => 70,
...
puts "today: (Monday 17th) 
#{monday_macros[0]}/3,207 calories, 
#{monday_macros[1]}/91g fat, 
#{monday_macros[2]}/120g protein, 
#{monday_macros[3]}/428g carbs  
#{monday_macros[4]}g fibre"

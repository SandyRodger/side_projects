...
yesterday_cook = {
	...
	:beetroot => 291,
	:babycorn => 146,
	:aldi_kidney_beans => 416,
	:rocket => 60,
	:baby_plum_tomatoes => 227,
}
...
today_cauliflower = {
	:aldi_kidney_beans_with_ring => 494,
	:red_onion => 183,
	:garlic => 41,
	:cauliflower => 456 + 404,
	:olive_oil => 32,
...
yesterday_weight = 762 + 1728
yesterday2_weight = 1495 + 791
today_sweet_potato_weight = 1751 + 447
today_cauliflower_weight = 709 + 1333 + 219
...
calories_fat_protein_carbs_fibre ={
	...
	:fruit_cake_with_icing => [3.50, 0.082, 0.039,0.652, 0.036],
...
yesterday_cook_macros = calories_calculator(yesterday_cook, calories_fat_protein_carbs_fibre)

yesterday_cook_grams = yesterday_cook_macros.map do |num|
	(num.to_f/yesterday_weight).round(3)
end

calories_fat_protein_carbs_fibre [:yesterday_cook_grams] = yesterday_cook_grams

# YESTERDAY2 COOK
yesterday2_cook_macros = calories_calculator(yesterday2_cook, calories_fat_protein_carbs_fibre)

yesterday2_cook_grams = yesterday2_cook_macros.map do |num|
	(num.to_f/yesterday2_weight).round(3)
end

calories_fat_protein_carbs_fibre [:yesterday2_cook_grams] = yesterday2_cook_grams

#TODAY_sweet_POTATO

today_sweet_potato_macros = calories_calculator(today_sweet_potato, calories_fat_protein_carbs_fibre)

today_sweet_potato_grams = today_sweet_potato_macros.map do |num|
	(num.to_f/today_sweet_potato_weight).round(3)
end

calories_fat_protein_carbs_fibre [:today_sweet_potato_grams] = today_sweet_potato_grams

# TODAY_CAULIFLOWER

today_cauliflower_macros = calories_calculator(today_cauliflower, calories_fat_protein_carbs_fibre)

today_cauliflower_grams = today_cauliflower_macros.map do |num|
	(num.to_f/today_cauliflower_weight).round(3)
end

calories_fat_protein_carbs_fibre [:today_cauliflower_grams] = today_cauliflower_grams

# puts "Each gram in today_cauliflower's cook has #{today_cauliflower_grams[0]} calories, #{today_cauliflower_grams[1]}g fat #{today_cauliflower_grams[2]}g protein, #{today_cauliflower_grams[3]}g carbs and  #{today_cauliflower_grams[4]}g fibre" 

today_input = {
  :vegan_gainz_protein => THREE_LEVEL_SCOOPS_VEGAN_GAINZ,
	:yesterday_cook_grams => 869,
	:apple => 104,
	:orange => 184,
	:banana => 80 * 2,
	:yesterday2_cook_grams => 702,
	:oatcakes => 64 * 2,
	:almond => 51 * 2,
	:today_sweet_potato_grams => 447,
	:today_cauliflower_grams => 219,
	:blueberries => 66
}

today_macros = calories_calculator(today_input, calories_fat_protein_carbs_fibre)

puts "today: (Wednesday 19th) 

...
today_weight = 762 + 1728
today2_weight = 1495 + 791
...
today_cook_macros = calories_calculator(today_cook, calories_fat_protein_carbs_fibre)

today_cook_grams = today_cook_macros.map do |num|
	(num.to_f/today_weight).round(3)
end

calories_fat_protein_carbs_fibre [:today_cook_grams] = today_cook_grams

today2_cook_macros = calories_calculator(today2_cook, calories_fat_protein_carbs_fibre)

today2_cook_grams = today2_cook_macros.map do |num|
	(num.to_f/today2_weight).round(3)
end

calories_fat_protein_carbs_fibre [:today2_cook_grams] = today2_cook_grams
# puts "Each gram in today2's cook has #{today2_cook_grams[0]} calories, #{today2_cook_grams[1]}g fat #{today2_cook_grams[2]}g protein, #{today2_cook_grams[3]}g carbs and  #{today2_cook_grams[4]}g fibre" 

today_input = {
  :vegan_gainz_protein => THREE_LEVEL_SCOOPS_VEGAN_GAINZ,
	:today_cook_grams => 762 + 842,
	:apple => 101 + 125,
	:orange => 188,
	:banana => 69,
	:almond => 46,
	:today2_cook_grams => 791 + 778,
	:raisins_and_cranberries => 100,
	:oatcakes => 64,
}

...
saturday_cook_macros_2 = calories_calculator(saturday_midday_cook, calories_fat_protein_carbs)
sunday_cook_macros = calories_calculator(sunday_cook, calories_fat_protein_carbs)

saturday_cook_grams_2 = saturday_cook_macros_2.map do |num|
	(num.to_f/saturday_weight_2 ).round(3)
end
...
calories_fat_protein_carbs [:saturday_cook_grams_2] = saturday_cook_grams_2
...
sunday_macros = calories_calculator(sunday_input, calories_fat_protein_carbs)

 puts "today (Sunday 2nd) thus far, i have consumed #{sunday_macros[0]}/3,207 calories, #{sunday_macros[1]}/91g fat, #{sunday_macros[2]}/120g protein, #{sunday_macros[3]}/428g carbs"
...
tuesday_sweet_potato = {
	...
	:flaxseed => 25,
	:rocket => 60,
	:aldi_kidney_beans_with_ring => 491
}
...
tuesday_sweet_potato_weight = 2166 + 300
tuesday_rice_weight = 1443 + 643 + 411
...
# puts "Each gram in tuesday_sweet_potato's cook has #{tuesday_sweet_potato_grams[0]} calories, #{tuesday_sweet_potato_grams[1]}g fat #{tuesday_sweet_potato_grams[2]}g protein, #{tuesday_sweet_potato_grams[3]}g carbs and  #{tuesday_sweet_potato_grams[4]}g fibre" 

today_input = {
	:huel_protein => 58,
	:tuesday_rice_grams => 411 + 680,
	:tuesday_sweet_potato_grams => 300,
	:apple => 104,
	:blueberries => 69,
	:orange => 115
}

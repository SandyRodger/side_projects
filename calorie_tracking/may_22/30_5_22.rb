...
monday_porridge = {
	...
	dark_soy_sauce: 43,
	tempeh: 200,
	aldi_kidney_beans: 240,
	nutritional_yeast: 30 
}

monday_porridge_weight = 1695 + 987
...
# puts "Each gram in sunday's_rice cook has #{sunday_rice_grams[0]} calories, #{sunday_rice_grams[1]}g fat #{sunday_rice_grams[2]}g protein, #{sunday_rice_grams[3]}g carbs and  #{sunday_rice_grams[4]}g fibre" 

today_input = {
	#GYM
	# whey_protein_amfit_salt_caramel: 60,
	# 1st meal: 12:00
	# sunday_rice_grams: 672, 
	# butter_milk: 166
	# 2nd meal: 16:20 + a coffee
	# aldi_oat_drink: 30,
	# monday_porridge_grams: 874,
	# Fruit 16:40
	# apple: 134,
	# kiwi: 70,
	# nectarine: 64
	# Meal 3: 6:10pm
	# monday_porridge_grams: 649
	# Meal 4 
	whole_seed_bread: 337-109,
	passata: 874 - 662,
	pickled_gherkins: 942 - 851,
	pickled_onions: 694 - 623,
	crunchy_PB: 171 - 146,
	mango: 142
}
